...
Item {
    ...
    Rectangle {
        ...
        // Use MouseArea instead of TapHandler to prevent Slider clicks from falling through
        MouseArea {
            anchors.fill: parent
    ...
    Rectangle {
        ...
        // ── SHIELD: Prevents clicks in the drawer from hitting the background ──
        MouseArea {
            anchors.fill: parent
            hoverEnabled: true
            onClicked: {} // Consume the click safely
        }
                ...
                SettingsRow {
                    ...
                    Row {
                        ...
                        Slider {
                            ...
                            enabled: !LweSettingsService.mute
                            width: 140
                            height: 24   // <--- FIX: Forces the slider to be visible!
                            stepSize: 1
                            anchors.verticalCenter: parent.verticalCenter
                            
                            onValueChanged: {
                                LweSettingsService.volume = Math.round(value)
                            }
                ...
                SettingsRow {
                    ...
                    Row {
                        ...
                        Slider {
                            ...
                            onValueChanged: {
                                LweSettingsService.fps = Math.round(value)
                            }
